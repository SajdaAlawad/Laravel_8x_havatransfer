            ...
            <table class="table table-bordered table-striped ">
                ...
                @foreach($images as $rs)
                    <tr class="table-info">
                        ...
                        <td>
                            <a href="{{route('admin_image_delete',['id'=>$rs->id,'product_id'=>$rs->id])}}" onclick="return confirm('Record will be Delete! are you sure?')"><img src="{{asset('assets/admin/image')}}/delete.png" height="25"></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
